...
public class ExpedienteService {
		...
		public Expediente buscarPorId(String cod) {
		...
		public String codigoExpediente() {
			return objExpediente.generarCodigoExpe();
		}
		public List<Expediente> listarExpedienteporEstado(String estado) {
			return objExpediente.listAllByEstado(estado);
		}
