...
<div class="container">
		...
		<!-- Nuevo Solicitantey Criterios de Búsqueda -->
        	...
        	fields:{
        		nomSoli:{
    		 		validators:{
    		 			...
    		 			regexp:{
    		 				regexp:/^[a-zA-Z\ñ\Ñ\s\á\é\í\ó\ú\Á\É\Í\Ó\Ú]{3,50}$/,
    		 	...
    		 	dniSoli:{
    		 		validators:{
    		 			...
    		 			regexp:{
    		 				regexp:/^[0-9]{8}$/,
    		 				message:'Ingrese solo 8 dígitos'
    		 			}
    		 		}
    		 	},
    		 	disSoli:{
    		 	...
    		 	direSoli:{
    		 		validators:{
    		 			...
    		 			regexp:{
    		 				...
    		 				message:'Ingrese mínimo 4 caracteres '
    		 			}
    		 		}
    		 	},
    		 	celSoli:{
    		 		validators:{
    		 			...
    		 			regexp:{
    		 				regexp:/^[0-9]{9}$/,
    		 				message:'Ingrese solo 9 dígitos'
    		 			}
    		 		}
    		 	},
    		 	sexo:{
