...
<body>
	<div class="container">
		...
		<!-- Nuevo Oficio y Criterios de Búsqueda -->
		...
		<button type="button" id ="ejemplo"class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
		  <img src="img/editar.png" class="am">Expediente
		</button>
		        ...
		        <form id="idRegistrarOficio" method="post" action="ServletExpediente?tipo=REGISTRAR">
					 ...
					 <div class="form-group col-4">
					  ...
					  <div class="form-group col-4">
					    ...
					    <input type="text" class="form-control" name="fechaSalida" id="idfechaSalida">
...
$(document).on("click",".btn-danger",function(){
	//variable
	let cod;
	//Obtener el codigo del oficio según el botón eliminar que se a pulsado
        		 ...
        		 fechaExpediente:{
     		 	...
     		 	contrato:{
    		 		validators:{
    		 			...
    		 			regexp:{
    		 				regexp:/^[0-9a-zA-Z\ñ\Ñ\s\á\é\í\ó\ú\Á\É\Í\Ó\Ú]{1,16}$/,
